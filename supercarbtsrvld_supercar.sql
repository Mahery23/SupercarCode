...
--
-- Host: mysql-supercarbtsrvld.alwaysdata.net
...
--
-- Database: `supercarbtsrvld_supercar`
--
...
CREATE TABLE `client_inscrit` (
  ...
  `mots_de_passe` text DEFAULT NULL,
...
(25, 'Steve', 'Mirija', 'Steve', 'steve@gmail.com', 'cEh0MXY3K3huRWQyRUFuZmFVSlo4UT09OjpIT0hQSE16Sm1xTlRhcDdWdnloaHl3PT0=', '2024-10-02'),
(27, 'Kevin', 'Andrianina', 'Kevs', 'kev@gmail.com', 'Y004N01EY1BRZWhjUVFKdWwxSkVIUT09OjpNbTV0QnBsdlVqQjE5NGtGTlRrOG53PT0=', '2024-11-18');
...
(12, 'homme', 'Steve', 'Mirija', 'steve@gmail.com', 'bonjour', '2024-11-19');
...
CREATE TABLE `demande_essai` (
  `id_demande_essai` int(11) NOT NULL,
  `date_demande` date DEFAULT NULL,
  `nom_utilisateur` varchar(50) NOT NULL,
  `nom_modele` varchar(50) NOT NULL,
  `heure_arriver` varchar(50) NOT NULL,
...
(46, '2024-11-21', 'Steve', 'Porsche 718 gt4 rs', '13:30', 'terminé');
...
CREATE TABLE `marque` (
  ...
  `description_marque` varchar(500) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `client_inscrit`
--
...
ALTER TABLE `concerner`
  ADD PRIMARY KEY (`id_evenement`,`id_voiture`),
...
ALTER TABLE `demande_essai`
  ADD PRIMARY KEY (`id_demande_essai`);
...
--
-- AUTO_INCREMENT for table `client_inscrit`
--
ALTER TABLE `client_inscrit`
...
--
ALTER TABLE `demande_essai`
  MODIFY `id_demande_essai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `marque`
  MODIFY `id_marque` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `modele`
--
ALTER TABLE `modele`
  MODIFY `id_modele` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT for table `voitures`
--
ALTER TABLE `voitures`
  MODIFY `id_voiture` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
